...
public class ExcelTools : EditorWindow
{
    ...
    /// 输出格式
    /// </summary>
    private static readonly string[] formatOption = new string[] { "TYPESCRIPT", "JSON", "CSV", "XML", "LUA" };
    ...
    private void DrawOptions()
    {
        ...
        EditorGUILayout.LabelField("文件输出路径: Assets/Excel");
    ...
    private static void Convert()
    {
        foreach (string assetsPath in excelList)
        {
            ...
            if (indexOfFormat == 0)
            {
                ...
                excel.ConvertToTs(output, encoding);
            }
